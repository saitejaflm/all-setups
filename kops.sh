...
aws s3api create-bucket --bucket saiteja.flm --region us-east-1
aws s3api put-bucket-versioning --bucket saiteja.flm --region us-east-1 --versioning-configuration Status=Enabled
